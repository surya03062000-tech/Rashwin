...
/* ---------- 2) Save-the-Date story card (1080 x 1350) — premium gold · cream · white ---------- */
const MAROON_INK = "#7a1f2b", INK_SOFT = "#6b584a";
const cardDefs = `
  <defs>
    <linearGradient id="cbg" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%"  stop-color="#fffefb"/>
      <stop offset="48%" stop-color="#fdf4e1"/>
      <stop offset="100%" stop-color="#f6e8cb"/>
    </linearGradient>
    ...
    <radialGradient id="cglow" cx="50%" cy="30%" r="60%">
      <stop offset="0%" stop-color="rgba(201,162,39,0.14)"/>
      <stop offset="100%" stop-color="rgba(201,162,39,0)"/>
    </radialGradient>
  </defs>`;

function cCorner(x, y, rot) {
  return `<g transform="translate(${x},${y}) rotate(${rot})" fill="none" stroke="url(#cgold)" stroke-width="2.2" opacity="0.95">
    <path d="M0 60 Q0 0 60 0"/>
    <path d="M12 60 Q12 12 60 12" opacity="0.6"/>
    <circle cx="0" cy="60" r="3" fill="url(#cgold)" stroke="none"/>
    <circle cx="60" cy="0" r="3" fill="url(#cgold)" stroke="none"/>
    <path d="M30 0 Q40 14 30 28 Q20 14 30 0 Z" fill="url(#cgold)" stroke="none" opacity="0.6"/>
  </g>`;
}
function cSprig(cx, cy, w) {
  return `<g transform="translate(${cx},${cy})" stroke="url(#cgold)" fill="url(#cgold)">
    <line x1="${-w}" y1="0" x2="${w}" y2="0" stroke-width="1.4"/>
    <circle cx="0" cy="0" r="5" stroke="none"/>
    <circle cx="${-w}" cy="0" r="2.5" stroke="none"/>
    <circle cx="${w}" cy="0" r="2.5" stroke="none"/>
    <path d="M-18 0 Q-9 -8 0 0 Q-9 8 -18 0 Z" stroke="none" opacity="0.9"/>
    <path d="M18 0 Q9 -8 0 0 Q9 8 18 0 Z"  stroke="none" opacity="0.9"/>
  </g>`;
}
...
const cardSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1350" viewBox="0 0 1080 1350">
  ...
  <rect width="1080" height="1350" fill="url(#cglow)"/>
  <rect x="34" y="34" width="1012" height="1282" fill="none" stroke="url(#cgold)" stroke-width="3"/>
  <rect x="52" y="52" width="976" height="1246" fill="none" stroke="url(#cgold)" stroke-width="1" opacity="0.55"/>
  ${cCorner(80,80,0)} ${cCorner(1000,80,90)} ${cCorner(1000,1270,180)} ${cCorner(80,1270,270)}
