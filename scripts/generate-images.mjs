...
/* ---------- 2) Save-the-Date story card (1080 x 1350) ---------- */
const cardSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1350" viewBox="0 0 1080 1350">
  ...
  <rect x="34" y="34" width="1012" height="1282" fill="none" stroke="url(#goldgrad)" stroke-width="3"/>
  <rect x="52" y="52" width="976" height="1246" fill="none" stroke="url(#goldgrad)" stroke-width="1" opacity="0.5"/>
  ${corner(80,80,0)} ${corner(1000,80,90)} ${corner(1000,1270,180)} ${corner(80,1270,270)}

  <g transform="translate(540,210)">
    <circle r="48" fill="none" stroke="url(#goldgrad)" stroke-width="2" opacity="0.7"/>
    <circle r="38" fill="none" stroke="url(#goldgrad)" stroke-width="1" opacity="0.4"/>
    <text x="0" y="22" text-anchor="middle" font-family="Playfair Display, serif" font-size="64" fill="url(#goldgrad)">✚</text>
  </g>
  ...
  <text x="540" y="740" text-anchor="middle" font-family="Playfair Display, serif" font-size="80" fill="#f1b8bf">❤</text>
  <text x="540" y="880" text-anchor="middle" font-family="Great Vibes, cursive" font-size="160" fill="${IVORY}">Jino</text>

  ${sprig(540,960,170)}

  <text x="540" y="1070" text-anchor="middle" font-family="Playfair Display, serif" font-weight="700" font-size="74" letter-spacing="10" fill="url(#goldgrad)">02 · 07 · 2026</text>
  ...
  <line x1="300" y1="1180" x2="780" y2="1180" stroke="url(#goldgrad)" stroke-width="1" opacity="0.5"/>
